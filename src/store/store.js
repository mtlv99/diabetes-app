...
export const store = configureStore({
  reducer: {
    ...
    ui: uiSlice.reducer,
    calendar: diabetesSlice.reducer,
  },
  ...
  /*
    Error original:
    A non-serializable value was detected in the state, in the path: `calendar.events.0.start`. Value: Mon Mar 13 2023 00:47:16 GMT-0600 (hora estándar central)
